...
Blockly.Python['bv_mesh_temporalhighpassfilterfft'] = function(block) {
...
Blockly.Python['bv_mesh_lineartrendremoval'] = function(block) {
...
Blockly.Python['bv_mesh_temporalgaussiansmoothing'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_spatialsmoothing'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
 ...
 * VMR
 */
Blockly.Python['bv_vmr_extendedtalspaceforvtccreation'] = function(block) {
  var value_fmrdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_vmr_useboundingboxforvtccreation'] = function(block) {
  var value_fmrdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_targetvtcboundingboxxstart'] = function(block) {
  var value_fmrdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_targetvtcboundingboxystart'] = function(block) {
  var value_fmrdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_targetvtcboundingboxzstart'] = function(block) {
  var value_fmrdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_targetvtcboundingboxxend'] = function(block) {
  var value_fmrdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_targetvtcboundingboxyend'] = function(block) {
  var value_fmrdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_targetvtcboundingboxzend'] = function(block) {
  var value_fmrdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_vmrvoxelresolutionx'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_vmrvoxelresolutiony'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_vmrvoxelresolutionz'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_filenameofcurrentvtc'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_meshscene'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
 ...
 * VMR functions
 */
 Blockly.Python['bv_vmr_linkvtc'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_vtcname = Blockly.Python.valueToCode(block, 'vtcname', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
  var code = value_bvdoc + '.LinkVTC(' + value_vtcname + ')\n';
  return code;
};

Blockly.Python['bv_vmr_linkstimulationprotocol'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_vmr_closedoc'] = function(block) {
...
Blockly.Python['bv_vmr_save'] = function(block) {
  var value_bv_doc = Blockly.Python.valueToCode(block, 'BV_DOC', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_autotransformtoisovoxel'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
  var code = value_bvdoc + '.AutoTransformToIsoVoxel(' + value_param1 + ', ' + value_param2 + ')';
  return [code, Blockly.Python.ORDER_ORDER_FUNCTION_CALL];
};

Blockly.Python['bv_vmr_autotransformtosag'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_setvoxelintensity'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_vmr_getvoxelintensity'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  var value_param3 = Blockly.Python.valueToCode(block, 'param3', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_vmr_correctintensityinhomogeneities'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_autoacpcandtaltransformation'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_createvtcinvmrspace'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  var value_param3 = Blockly.Python.valueToCode(block, 'param3', Blockly.Python.ORDER_ATOMIC);
  ...
  var value_param6 = Blockly.Python.valueToCode(block, 'param6', Blockly.Python.ORDER_ATOMIC);
  var value_param7 = Blockly.Python.valueToCode(block, 'param7', Blockly.Python.ORDER_ATOMIC);
  var value_param8 = Blockly.Python.valueToCode(block, 'param8', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_createvtcinacpcspace'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  var value_param3 = Blockly.Python.valueToCode(block, 'param3', Blockly.Python.ORDER_ATOMIC);
  ...
  var value_param7 = Blockly.Python.valueToCode(block, 'param7', Blockly.Python.ORDER_ATOMIC);
  var value_param8 = Blockly.Python.valueToCode(block, 'param8', Blockly.Python.ORDER_ATOMIC);
  var value_param9 = Blockly.Python.valueToCode(block, 'param9', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_createvtcintalspace'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  var value_param3 = Blockly.Python.valueToCode(block, 'param3', Blockly.Python.ORDER_ATOMIC);
  ...
  var value_param8 = Blockly.Python.valueToCode(block, 'param8', Blockly.Python.ORDER_ATOMIC);
  var value_param9 = Blockly.Python.valueToCode(block, 'param9', Blockly.Python.ORDER_ATOMIC);
  var value_param10 = Blockly.Python.valueToCode(block, 'param10', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_correctforserialcorrelations'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_separationofsubjectpredictors'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_separationofstudypredictors'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_ztransformstudies'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_psctransformstudies'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_ztransformstudiesbaselineonly'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_loadsinglestudyglmdesignmatrix'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_loadmultistudyglmdefinitionfile'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_computesinglestudyglm'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_computemultistudyglm'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_computerfxglm'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_showglm'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_loadglm'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_saveglm'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_clearcontrasts'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
   // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_addcontrast'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_setcontraststring'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_setcurrentcontrastatindex'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_setcontrastvalueatindex'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_setcurrentcontrast'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_setcontrastvalue'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
 ...
 * VOI/ROI
 */
 Blockly.Python['bv_vmr_nrofvois'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
 ...
 Blockly.Python['bv_vmr_nrofpredictorsinsinglestudydm'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_nroftimepointsinsinglestudydm'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
  var code = value_bvdoc + '.NrOfTimePointsInSingleStudyDM';
  return [code, Blockly.Python.ORDER_MEMBER];
};
Blockly.Python['bv_vmr_nrofroicontrasts'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_loadvoifile'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_hideallvois'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_selectvoi'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_getnameofvoi'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_showselectedvois'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_prepareroicontrasts'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_addroicontrast'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_computesinglestudyglmforvoi'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  var value_param3 = Blockly.Python.valueToCode(block, 'param3', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_vmr_getnameofroicontrast'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_gettvalueofroicontrast'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_getpvalueofroicontrast'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_loadmesh'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_addmesh'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_savemesh'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_updatesurfacewindow'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_savesnapshotofsurfacewindow'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_linkmtc'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
...
Blockly.Python['bv_vmr_createmtcfromvtc'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
  var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
  var value_param3 = Blockly.Python.valueToCode(block, 'param3', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_vmr_getmeshscene'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var code = value_bvdoc + '.GetMeshScene()';
  return [code, Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['bv_vmr_viewpointtranslationx'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_viewpointtranslationy'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_viewpointtranslationz'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_viewpointrotationx'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_viewpointrotationy'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_vmr_viewpointrotationz'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_meshscene_currentmesh'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var code = value_bvdoc + '.CurrentMesh';
  return [code, Blockly.Python.ORDER_MEMBER];
};

Blockly.Python['bv_meshscene_viewpointpositionx'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_meshscene_viewpointpositiony'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_meshscene_viewpointpositionz'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_meshscene_viewpointrotationx'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_meshscene_viewpointrotationy'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_meshscene_viewpointrotationz'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_meshscene_sphereresolutioncba'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_mesh_filename'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.FileName';
    return [code, Blockly.Python.ORDER_MEMBER];
};

Blockly.Python['bv_mesh_nrofvertices'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.NrOfVertices';
    return [code, Blockly.Python.ORDER_MEMBER];
};

Blockly.Python['bv_mesh_morphingupdateinterval'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_mesh_correctforserialcorrelations'] = function(block) {
  var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
  var dropdown_property = block.getFieldValue('PROPERTY');
  var code;
  if (dropdown_property == 'SET') {
...
Blockly.Python['bv_mesh_updatesurfacewindow'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.MeshScene.UpdateSurfaceWindow()\n';
    return code;
};

Blockly.Python['bv_mesh_saveas'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_calculatecurvaturecba'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.CalculateCurvatureCBA()';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['bv_mesh_smoothcurrentmap'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_inflatemeshtosphere'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_correctinflatedspheremesh'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_mapspheremeshfromstandardsphere'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.MapSphereMeshFromStandardSphere()';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['bv_mesh_setstandardspheretofoldedmesh'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_createmultiscalecurvaturemap'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
    var value_param3 = Blockly.Python.valueToCode(block, 'param3', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_createsphericalcoordinatesmapfromsmp'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_smoothmesh'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_smoothrecomesh'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_calculatecurvature'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.CalculateCurvature()\n';
    return code;
};

Blockly.Python['bv_mesh_inflatemesh'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
    var value_param3 = Blockly.Python.valueToCode(block, 'param3', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_createmtcfromvtc'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var value_param2 = Blockly.Python.valueToCode(block, 'param2', Blockly.Python.ORDER_ATOMIC);
    var value_param3 = Blockly.Python.valueToCode(block, 'param3', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_linkmtc'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.LinkMTC('+ value_param1 + ')';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
...
Blockly.Python['bv_mesh_savemtc'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_mesh_cleardesignmatrix'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.ClearDesignMatrix() \n';
    return code;
};

Blockly.Python['bv_mesh_loadsinglestudyglmdesignmatrix'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.LoadSingleStudyGLMDesignMatrix('+ value_param1 + ')';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
...
Blockly.Python['bv_mesh_computesinglestudyglm'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.ComputeSingleStudyGLM() \n';
    return code;
};

Blockly.Python['bv_mesh_showglm'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.ShowGLM()\n';
    return code;
};

Blockly.Python['bv_mesh_saveglm'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.SaveGLM('+ value_param1 + ')\n';
    return code;
...
Blockly.Python['bv_meshscene_loadmesh'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.LoadMesh(' + value_param1 + ')';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
...
Blockly.Python['bv_meshscene_mapspheremeshfromstandardsphere'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.MapSphereMeshFromStandardSphere()';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['bv_meshscene_setstandardspheretofoldedmesh'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.SetStandardSphereToFoldedMesh(' + value_param1 + ')';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
...
Blockly.Python['bv_meshscene_createstandardspheremesh'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.CreateStandardSphereMesh()';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['bv_meshscene_cleargroupcbacurvaturefiles'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.ClearGroupCBACurvatureFiles()';
    return code;
};

Blockly.Python['bv_meshscene_addcurvaturefileforgroupcba'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_meshscene_runrigidcba'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var value_param1 = Blockly.Python.valueToCode(block, 'param1', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['bv_meshscene_runcba'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.RunCBA()';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['bv_meshscene_createaveragecurvaturegroupmap'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
    var code = value_bvdoc + '.CreateAverageCurvatureGroupMap()';
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.Python['bv_meshscene_createaveragefoldedgroupmesh'] = function(block) {
	var value_bvdoc = Blockly.Python.valueToCode(block, 'bvdoc', Blockly.Python.ORDER_ATOMIC);
